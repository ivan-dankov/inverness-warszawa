 ...
 * Using individual icon file imports for optimal tree-shaking and minimal bundle size
 * This ensures only the icons we use are bundled, not the entire library
 */
...
export { default as Baby } from "lucide-react/dist/esm/icons/baby";

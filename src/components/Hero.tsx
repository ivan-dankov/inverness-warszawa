...
export const Hero = () => {
  ...
  return <section className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-rose-50 via-rose-100 to-pink-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-6 leading-tight lg:text-5xl">
              ...
              <img src={logo} alt="Inverness MED" className="block mt-4 max-w-sm " />
            </h1>

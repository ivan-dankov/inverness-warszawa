        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="max-w-2xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6 leading-tight">
              <span className="text-teal-600 py-0 my-0">gentle piercing</span> {t('hero.title')}
            </h1>
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 text-xs sm:text-sm text-muted-foreground">
              {(t('hero.features', {
              returnObjects: true
            }) as string[]).map((feature: string, index: number) => <div key={index} className="flex items-center gap-2">
          ...
          <div className="hidden lg:grid grid-cols-2 gap-4 relative">
            ...
            const altTexts = ["System Inverness MED do bezpiecznego przekłuwania uszu", "Profesjonalny sprzęt Inverness do medycznego przekłuwania", "Kolekcja medycznych kolczyków Inverness", "Eleganckie kolczyki medyczne po przekłuciu"];

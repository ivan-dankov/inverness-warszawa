...
export const Earrings = () => {
  ...
  return <section id="earrings" className="py-12 sm:py-20 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          {displayedEarrings.map((earring, index) => <div key={index} onClick={() => navigate(`/earrings/${index}`)} className="relative aspect-square cursor-pointer overflow-hidden rounded-lg group">
          ...
          {/* See All Tile */}
          <div onClick={() => navigate('/earrings')} className="relative aspect-square overflow-hidden rounded-lg shadow-soft hover:shadow-card transition-all duration-300 group cursor-pointer bg-muted/50 flex items-center justify-center hover:bg-primary/10">

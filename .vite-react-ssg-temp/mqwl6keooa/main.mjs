...
import { H as Helmet, a as HelmetProvider } from "./assets/js/react-core-DmnhavI8.js";
...
const Gallery = lazy(() => import("./assets/js/Gallery-HrKaJuwx.js").then((m) => ({ default: m.Gallery })));
const Testimonials = lazy(() => import("./assets/js/Testimonials-9N_b-7fg.js").then((m) => ({ default: m.Testimonials })));
const Comparison = lazy(() => import("./assets/js/Comparison-DWkWgM7X.js").then((m) => ({ default: m.Comparison })));
const FAQ = lazy(() => import("./assets/js/FAQ-CTPa6ukf.js").then((m) => ({ default: m.FAQ })));
const RecentArticles = lazy(() => import("./assets/js/RecentArticles-DrpGvfUX.js").then((m) => ({ default: m.RecentArticles })));
const Contact = lazy(() => import("./assets/js/Contact-CUccHIG1.js").then((m) => ({ default: m.Contact })));
